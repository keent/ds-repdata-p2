...
We do this by counting 1 fatality as 1 total effect and 2 injuries as 1 total effect.
```{r}
...
Then we tidy the Property Damage Exponent and the Crop Damage Exponent.
We also create another column which we use to multiply with the Property Damage Cost and the Crop Damage Cost.
Finally we sum both costs to create another column called TOTALECODMG, short for "Total Economic Damage
